...
cp "$script_dir/.github/prompts/contextiq.prompt.md" "$target_dir/.github/prompts/contextiq.prompt.md"

echo "Installed ContextIQ MCP starter into $target_dir"
echo "Next: open the target repo in VS Code, run the 'setup-contextiq-dev-login' task once, then reload and use '/contextiq'."